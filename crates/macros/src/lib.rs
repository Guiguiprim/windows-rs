    ...
    let tokens = quote! {
        {
            ...
            // TODO:
            // - get_crate_winmds already provides winmds for the current crate and the
            //   base windmds from windows_gen;
            // - Copying DLL dependencies to target/ (or any other folder used to package
            //   the resulting project) should be up to the crate using windows-rs.
            // IOW: All .windows/ handling has been removed.
        }
    };
